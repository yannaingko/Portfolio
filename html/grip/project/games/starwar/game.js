...
let score = 0;
let countdown;
let hightscore = localStorage.getItem('gamehighscore') || 0 ;
highscoreBoard.textContent = 'HIGH SCORE: ' + hightscore;
...
document.querySelector('.button').onclick = clearscore;

function clearscore(){
    localStorage.clear('gamehighscore');
}
